    ...
    execute: () =>
      sql`
        SELECT
          ...
          pin_position AS "pinPosition",
          thread_order_key AS "threadOrderKey",
          ...
          ([
            ...
            Effect.gen(function* () {
              ...
              const threads: ReadonlyArray<OrchestrationThread> = threadRows.map((row) => ({
                ...
                pinPosition: row.pinPosition ?? null,
                threadOrderKey: row.threadOrderKey ?? null,
  ...
  const getThreadShellById: ProjectionSnapshotQueryShape["getThreadShellById"] = (threadId) =>
    Effect.gen(function* () {
      ...
      return Option.some({
        ...
        pinPosition: threadRow.value.pinPosition ?? null,
        threadOrderKey: threadRow.value.threadOrderKey ?? null,
