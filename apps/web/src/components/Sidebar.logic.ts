...
export function resolveThreadRowClassName(input: {
  ...
  const baseClassName =
    "h-8 w-full translate-x-0 cursor-pointer justify-start rounded-md bg-sidebar-row-rest px-2 text-left text-sm select-none focus-visible:ring-1 focus-visible:ring-inset focus-visible:ring-ring";
