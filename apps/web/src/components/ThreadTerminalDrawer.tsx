...
export function TerminalViewport({
  ...
  return (
    <div className="flex h-full w-full flex-col overflow-hidden bg-(--terminal-background)">
      ...
      <div
        ref={containerRef}
        tabIndex={-1}
        className="relative min-h-0 w-full flex-1 overflow-hidden bg-(--terminal-background)"
      />
    </div>
  );
}
