...
// Mock MdreviewRenderer — the real implementation depends on @mdreview/core
// which may not be available in the unit test environment
...
describe("FileViewer", () => {
  it("renders markdown content via MdreviewRenderer when path ends in .md", () => {
    ...
    // The mocked MdreviewRenderer outputs data-testid="mdreview-renderer"
    // and renders the source as text content
  ...
  it("renders code content with Shiki fallback for .ts files", () => {
    ...
    // Should NOT render MdreviewRenderer
    expect(html).not.toContain("mdreview-renderer");
  });
